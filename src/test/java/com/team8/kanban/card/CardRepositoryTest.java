...
//
//    @Test
//    @DisplayName("section별 카드 조회(정렬기준:position) -성공")
//    void test1() {
//        //given
//        setup();
//        Long sectionId = 1L;
...
//
//    @Test
//    @DisplayName("section별 카드 조회(정렬기준:position) -카드가없을때")
//    void test2() {
//        //given
//        Long sectionId = 1L;
//        //when
...
//
//    @Test
//    @DisplayName("section별 카드 조회(정렬기준:cardId) -성공")
//    void test5() {
//        //given
//        setup();
//        Long sectionId = 1L;
//
//        //when
//        List<Card> cardList = cardRepositoryImpl.findCardsBySectionId(sectionId);
//
//        //then
//        assertEquals(2, cardList.size());
//        assertEquals(sectionId, cardList.stream().findAny().get().getSectionId());
//        assertEquals(card1.getCardId(), cardList.get(0).getCardId());
//    }
//
//    @Test
//    @DisplayName("section별 카드 조회(정렬기준:cardId) -카드가없을때")
//    void test6() {
//        //given
//        Long sectionId = 1L;
//
